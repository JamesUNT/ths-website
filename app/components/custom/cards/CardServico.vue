  ...
  >
    ...
    <div class="relative h-48 w-full overflow-hidden">
      ...
      >
        <div class="flex items-center gap-2">
          <span class="text-ths-green font-mono text-xs font-bold">{{
            id
          }}</span>
          <span
            class="border-ths-green/30 text-ths-green rounded border bg-emerald-950/40 px-2 py-0.5 text-[10px] font-bold tracking-wider uppercase"
          >
            {{ badge }}
          </span>
        </div>
    ...
    <div class="flex flex-1 flex-col p-6 pt-3">
      ...
      <div class="mt-auto flex items-center justify-between">
        ...
        <span
          class="text-ths-green text-xl font-black tracking-tight sm:text-2xl"
        >
          {{ precos[veiculoAtivo] }}
        </span>
